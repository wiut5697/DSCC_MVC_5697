using DSCC_CW1_MVC_5697.Models;
using System;
...
namespace DSCC_CW1_MVC_5697.Controllers
{
    public class ProductController : Controller
    {
        ...
        private List<Product> Get()
        {
            try
            {
                ...
                var getDataTask = client.GetAsync("https://localhost:44392/api/product").ContinueWith(response => {
        ...
        public ActionResult Create(Product product)
        {
            ...
            {
                client.BaseAddress = new Uri("https://localhost:44392/api/product");
        ...
        public ActionResult Edit(Product product)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("https://localhost:44392/api/product/" + product.Id);
